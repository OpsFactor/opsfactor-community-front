 ...
 */
export interface PlanningBookGroup<TLocationMap extends PlanningBookDescriptorMap = PlanningBookDescriptorMap, TMaterialMap extends PlanningBookDescriptorMap = PlanningBookDescriptorMap, TValue = unknown> {
 ...
 */
export interface FlattenedPlanningBookRow<TLocationMap extends PlanningBookDescriptorMap = PlanningBookDescriptorMap, TMaterialMap extends PlanningBookDescriptorMap = PlanningBookDescriptorMap, TValue = unknown> {
...
//# sourceMappingURL=planning-book.model.d.ts.map