 ...
 */
export type PlanningBookEditMode = 'cellEdit' | 'detailEdit' | 'detailOrCellEdit' | 'detailDisaggregatedOnly' | 'detailAggregatedDisaggregated' | 'noEdit' | string;
export type PlanningBookAggregationModel = 'PADRAO' | 'RELACAO_ENTRE_VALORES' | 'RAZAO_ENTRE_SOMAS' | string;
...
//# sourceMappingURL=planning-book.dto.d.ts.map