 ...
 */
export function resolveCanonicalJsonDataIntegrationPath(path) {
 ...
 */
export function resolveCanonicalDataIntegrationPath(path, transport) {
    if (path.startsWith(LEGACY_DATA_UPLOAD_JSON_ROOT)) {
        return `${CANONICAL_DATA_ROOT}${path.slice(LEGACY_DATA_UPLOAD_JSON_ROOT.length)}`;
    }
...
//# sourceMappingURL=canonical-data-integration-path.js.map