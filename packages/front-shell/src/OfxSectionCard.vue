...
<template>
  <section class="ofx-section-card flex h-full min-h-0 flex-col overflow-hidden rounded-[14px] border shadow-[var(--ofx-shadow-md)]">
    ...
    <div class="ofx-section-card__body flex min-h-0 flex-1 flex-col px-4 py-3 sm:px-5"><slot /></div>
  </section>
</template>
