...
const legacyNavigationModules: AppNavigationModuleDefinition[] = [
  {
    ...
    overviewDescription: 'Demand Planning keeps forecast work, sales and demand visibility, and demand-specific analytics together without reproducing the old screen tree.',
        ...
        items: [
          {
            ...
            description: 'Legacy demand planning book entry point for forecast editing and work-version review.',
          ...
          },
          {
            ...
            description: 'Demand-plan archive with legacy columns, export, selection, and batch deletion.',
        ...
        items: [
          {
            ...
            description: 'Sales and demand overview workspace with chart and pivot analysis backed by the legacy consolidated-plan contract.',
        ...
        items: [
          {
            ...
            description: 'Legacy demand analysis screen, treated here as cluster-level configuration for demand segmentation.',
  ...
  },
  {
    ...
    overviewDescription: 'Supply Chain Planning groups the supply planning book, legacy analytical support screens, visibility flows, and the migrated execution-profile form behind one task-oriented context.',
        ...
        items: [
          {
            ...
            description: 'Legacy supply planning book entry point.',
          ...
          },
          {
            ...
            description: 'Migrated execution-profile editor with real backend integration and sectioned forms.',
        ...
        items: [
          {
            ...
            description: 'Legacy production planning book entry point.',
        ...
        items: [
          {
            ...
            description: 'Migrated BI workspace with charts, pivoting, and occupation-by-resource tables for production review.',
  ...
  },
  {
    ...
    overviewDescription: 'Processes now exposes execution and status as separate operational tasks instead of burying them behind a launcher screen.',
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Open the backend Swagger UI for endpoint inspection and contract lookup.',
  ...
  },
  {
    ...
    overviewDescription: 'Configuration is intentionally highlighted as its own module so parameter maintenance stays easy to find and easy to adjust as the navigation evolves.',
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Transportation-line configuration for network movements and logistics setup.',
            keywords: ['transportation line', 'transport', 'road', 'logistics line'],
          ...
          },
          {
            ...
            description: 'Global parameter maintenance, preserved as a visible transplant even though the legacy mapping was inconsistent.',
        ...
        items: [
          {
            ...
            description: 'Supporting material-filter configuration from the legacy setup area.',
          ...
          },
          {
            ...
            description: 'Legacy product-details configuration support screen.',
  ...
  },
  {
    ...
    overviewDescription: 'Admin remains separate from Configuration so user-management, user-level preferences, and global application administration stay clearly distinguishable from planning parameter maintenance.',
        ...
        items: [
          {
            ...
            label: 'Users',
            path: '/admin/users',
            description: 'User administration, access maintenance, and permissions embedded in the same screen.',
