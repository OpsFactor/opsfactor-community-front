...
function handleDocumentClick(event: MouseEvent) {
  ...
  // The teleported menu is outside the trigger root but remains part of this control.
  if (target && rootRef.value && !rootRef.value.contains(target) && !menuRef.value?.contains(target)) {
